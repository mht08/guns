...
$(function () {
    ...
    function scrollTabLeft() {
        ...
        // 减可视区域tab宽度，小于可视区域直接返回到首页位置
        var newVal = marginLeftVal - visibleWidth;
        if(visibleWidth > marginLeftVal) {
        	newVal = 0;
        }
        $('.page-tabs-content').animate({
            marginLeft: '-'+ newVal + 'px'
        }, "fast");
    }
    ...
    function scrollTabRight() {
        ...
        // 可视区域非tab宽度
        var tabOuterWidth = MyCrontab.calSumWidth($(".content-tabs").children().not(".J_menuTabs"));
        console.log("tabOuterWidth:" +tabOuterWidth);
        //可视区域tab宽度
        var visibleWidth = $(".content-tabs").outerWidth(true) - tabOuterWidth;
        //获取最大长度
        var menuTabWidth = MyCrontab.calSumWidth($(".page-tabs-content").children());
        ...
        if ($(".page-tabs-content").width() < visibleWidth) {
        	...
        	var newVal = marginLeftVal + visibleWidth;
            if(newVal >= menuTabWidth) {
            	newVal = marginLeftVal;
            } 
    ...
    function closeTab() {
        ...
        if ($(this).parents('.J_menuTab').hasClass('active')) {
            ...
            if ($(this).parents('.J_menuTab').next('.J_menuTab').size()) {
                ...
                if (marginLeftVal < 0) {
                	var newCount = marginLeftVal + currentWidth;
                	if(newCount >0) {
                		newCount = 0;
                	}
                    $('.page-tabs-content').animate({
                        marginLeft: newCount + 'px'
                    }, "fast");
                }
